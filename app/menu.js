...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    const subMenuAbout = {
      label: 'UltimateDevelopment',
      submenu: [
        { label: 'About UltimateDevelopment', selector: 'orderFrontStandardAboutPanel:' },
        { type: 'separator' },
        { label: 'Services', submenu: [] },
        { type: 'separator' },
        { label: 'Hide UltimateDevelopment', accelerator: 'Command+H', selector: 'hide:' },
